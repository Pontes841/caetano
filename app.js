...
const createConnection = async () => {
    return await mysql.createConnection({
        host: '212.1.208.101',
        user: 'u896627913_jeremoabo',
        password: 'Felipe.91118825',
        database: 'u896627913_jeremoabo'
    });
}
                    ...
                    if (agendamento.data_inclusao && agendamento.data_inclusao <= hoje && !agendamento.enviado) {
                        ...
                        if (agendamento.mensagemvd && agendamento.mensagemvd !== '') {
                            ...
                            try {
                                ...
                                const linkURL = 'https://www.instagram.com/oticasdinizjeremoabo?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=='; // Replace this with your desired link URL
